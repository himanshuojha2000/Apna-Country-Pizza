        ...
        try {
            ...
            utp.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull final DataSnapshot snapshot) {
                    ...
                    final String m=snapshot.child("tad").getValue(String.class);


                    final int o=snapshot.child("finalam").getValue(Integer.class);
                    ...
                    if(!snapshot.hasChild("TotalOrders")){
                        ...
                        final DatabaseReference mtp= FirebaseDatabase.getInstance().getReference();


                        mtp.addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot isnapshot) {


                                int h=(isnapshot.child("LiveOrders").getValue(Integer.class));


                                mtp.child("AllLiveOrders").child(String.valueOf(h)).child("DateandTime").setValue(String.valueOf(Date));
                                mtp.child("AllLiveOrders").child(String.valueOf(h)).child("PhoneNumber").setValue(phone);
                                mtp.child("AllLiveOrders").child(String.valueOf(h)).child("DeliveryAddress").setValue(m);
                                mtp.child("AllLiveOrders").child(String.valueOf(h)).child("ModeOfPayment").setValue(snapshot.child("temporder").child("paymentmode").getValue());
                                mtp.child("AllLiveOrders").child(String.valueOf(h)).child("Amounttopaid").setValue(o);
                                mtp.child("AllLiveOrders").child(String.valueOf(h)).child("OrderStatus").setValue("Waiting For Confirmation");
                                mtp.child("AllLiveOrders").child(String.valueOf(h)).child("AmountStatus").setValue("Paid");

                                mtp.child("AllLiveOrders").child(String.valueOf(h)).child("Oid").setValue(String.valueOf(TO));

                                mtp.child("AllLiveOrders").child(String.valueOf(h)).child("LOID").setValue(String.valueOf(h));
                                mtp.child("AllLiveOrders").child(String.valueOf(h)).child("Items").setValue(  snapshot.child("cart").getValue());


                                h=h+1;
                                mtp.child("LiveOrders").setValue(h);
